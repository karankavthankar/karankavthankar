...
const karan = {
  ...
  education: "CSE @ Kolhapur Institute of Technology's College of Engineering (Class of '28)",
  stack: ["MERN Stack", "C++", "Data Structures & Algorithms"],
  currentlyDoing: [
    "Solving DSA problems daily in C++",
    "Building scalable full stack web applications",
    "Preparing for internships",
    "Participating in hackathons for real-world experience",
  ],
  involvement: "Technical Team Member @ CSI Club",
  strengths: ["Problem Solving", "Teamwork", "Fast Learner", "Time Management"],
  status: "Open to Work 🟢",
...
![Skills](https://skillicons.dev/icons?i=cpp,java,c,js)
